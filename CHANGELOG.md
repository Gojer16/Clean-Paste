...
### Fixed
- Fixed an issue where Obsidian tag lists (e.g., `#Technology #tech #AI`) were being incorrectly formatted as headings.
- Improved heading/tag disambiguation to ensure multi-tag lines are preserved exactly as they are.
